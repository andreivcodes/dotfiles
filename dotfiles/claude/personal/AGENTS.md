...
This file contains critical rules that apply across all Claude Code sessions for the personal profile.
...
- `Co-Authored-By: Claude` or any similar AI co-author lines
- `🤖 Generated with Claude Code` or similar footers
- Any mention of AI, Claude, assistant, or automated generation
